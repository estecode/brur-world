...
export BRUR_PR_CHECK_CHANGED_FILES="scripts/geodot_poc_tuned_main.gd scripts/geodot_far_renderer.gd scripts/geodot_budgeted_world_renderer.gd tests/godot/test_geodot_runtime_hlod_integration.gd"
