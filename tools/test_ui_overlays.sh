...
# Runs deterministic persistent-overlay, Drive HUD, layout, collapse/restore, Lund-control, and debug-log contracts.
...
run_test "tests/godot/test_drive_hud.gd" "godot Drive HUD tests: OK"
