...
ROUTE_GEOMETRY_DATASET_OWNERS=frozenset({"tools/build_routing.py","tools/build_routing_dataset.py","tools/check_route_geometry_dataset.py","tools/route_geometry.py","tools/world_common.py"})
ROAD_LOD_DATASET_OWNERS=frozenset({"tools/build_roads.py","tools/road_surface_mesh.py","tools/world_common.py","scripts/road_lod_policy.gd","scripts/main.gd","tests/test_road_surface_mesh.py","tests/godot/test_road_surface_mesh_runtime.gd"})
CITY_LIGHT_OWNERS=frozenset({"tools/build_city_light_density.py","tools/test_city_lights_real_data.sh","scripts/city_light_model.gd","scripts/city_light_renderer.gd","tests/godot/test_city_lights.gd","tests/godot/test_city_lights_real_data.gd"})
WORLD_SHOWCASE_OWNERS=frozenset({"tools/prepare_world_showcase.py","tests/test_world_showcase_prepare.py"})
BUILDING_TILE_OWNERS=frozenset({"tools/build_building_tiles.py","tools/build_building_mesh_pyramid.py","tools/build_sweden.py","scripts/building_lod_policy.gd","scripts/building_mesh_chunk_codec.gd","scripts/building_stream_layer.gd","scripts/building_runtime_composition.gd","scripts/camera_controller.gd","scenes/main.tscn"})
